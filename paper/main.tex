...
\section{Scope Freeze Declaration}
\label{sec:scope-freeze}

This release candidate locks the core publication scope.
...
Deferred items are explicitly parked to the extension track and are non-blocking for core acceptance:
...
\section{First-Pass Extensions (Draft)}
\label{sec:extension-first-pass}

This section executes a first drafting pass over the extension parking set while preserving the core scope lock.
The material in this section and Annex~G is draft design text for review and hardening; it does not
alter core conformance claims in Annex~D.
...
REQ-TST-003 & N & Y & Anti-pattern suite report + fail-closed receipts & Per full-profile release candidate \\
\rowcolor{tablerowgray}
...
\section{Annex G: First-Pass Extension Pack (Draft)}
\label{ann:extension-first-pass}

This annex contains first-pass extension drafting artefacts.
