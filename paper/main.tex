...
\rowcolor{tablerowgray}
Test controls & Validate governance behaviour at release time & REQ-TST-001..002 & Test vector run report + failure receipts \\
\end{tabularx}
\end{center}
...
Items here are implementation-oriented and review-ready, but are not yet locked as Annex~B normative clauses.
