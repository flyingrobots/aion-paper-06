...
\textbf{Reference artefact pointers (RC2 harness).}
For reproducible RC2 evidence generation, the reference harness publishes:
\begin{itemize}[leftmargin=*]
  \item \path{harness/reports/rc2-vector-run-latest.md}
  \item \path{harness/reports/rc2-harness-determinism-latest.txt}
  \item \path{harness/reports/rc2-policy-parse-latest.md}
  \item \path{harness/reports/rc2-traceability-audit-latest.md}
\end{itemize}
